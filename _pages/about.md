...
- Face Super-Resolution Reconstruction Based on Attention Residual Network. [Paper](https://kns.cnki.net/kcms2/article/abstract?v=olK-MAP09vd8bm-DmdqoUDudjxh44PKImweiGGWIVzY620icTGSFS07-vjEZqSci5yDu67nzu-ODYWlFt-cMa8iElJ2_BaNmk1NGF1ds-GJ7oIRIr-dRKRF5BvHTZ4ESBX86mvCWSrsDFI_87Py7Ec9n5xney4CsnM1cFbmnOxkYvxK2NBMvLg==&uniplatform=NZKPT&language=CHS)
<br>**Tongguan Wang**, H. Lai, Y. Cai, et al. *Computer Engineering*, 2022.

- A Unified Generative Framework for Bilingual Euphemism Detection and Identification. [Paper](https://aclanthology.org/2024.findings-acl.403/)
<br>Y. Hu\*, J. Li\*, **Tongguan Wang\***, et al. Findings of ACL, 2024.

### Co-Authored Publications

- Beyond Words: Enhancing Desire, Emotion, and Sentiment Recognition with Non-Verbal Cues. [Paper](https://dl.acm.org/doi/abs/10.1145/3774904.3792393)
<br>W. Chen, **Tongguan Wang**, F. Xue, et al. WWW, 2026. **(CCF-A)**

- Chinese Two-Part Allegorical Sayings Reading Comprehension: Exploration from Reasoning to Metaphor. [Paper](https://ojs.aaai.org/index.php/AAAI/article/view/40588)
...
- A Dual-Level Indicative Representation Learning Method for Multimodal Sarcasm Detection. [Paper](https://www.sciencedirect.com/science/article/abs/pii/S030645732600230X)
<br>Y. Zhang, G. Su, **Tongguan Wang**, et al. *Information Processing & Management*, 2026. **(JCR Q1)**

- Unified Grid Tagging Scheme for Aspect Sentiment Quad Prediction. [Paper](https://aclanthology.org/2025.coling-main.269/)
<br>G. Su, Y. Zhang, **Tongguan Wang**, et al. COLING, 2025. **(CCF-B)**

For more publications, please see my [Google Scholar](https://scholar.google.com/citations?user=HDEf4U4AAAAJ&hl=zh-CN)

❤ Academic Service
======

- **Conference Reviewer:** ACL Rolling Review, AAAI, ICME, and NLPCC.
- **Journal Reviewer:** IEEE TNNLS, IEEE TCSVT, IEEE ACCESS, The Visual Computer, Applied Soft Computing, Scientific Reports, Journal of King Saud University Computer and Information Sciences

🏆 Honors
======

- First Prize, Annual Academic Conference, Huazhong Agricultural University, 2024 and 2025
- Outstanding Graduate Student, Huazhong Agricultural University, 2024 and 2025
